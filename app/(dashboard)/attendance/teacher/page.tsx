        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="flex flex-col gap-1.5 min-w-[140px]">
            ...
            <input type="date" value={filterDate} onChange={(e) => setFilterDate(e.target.value)}
              className="w-full px-3 py-2 border border-border rounded-lg text-[13px] outline-none focus:border-[#F59E0B] bg-white dark:bg-slate-900 font-medium" />
          </div>
        </div>
      </div>
          ...
          <div>
            <div className="p-4 border-b border-border bg-slate-50 dark:bg-slate-800/50 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Search teacher..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
                  className="pl-9 pr-3 py-1.5 border border-border rounded-lg text-[13px] outline-none focus:border-[#F59E0B] bg-white dark:bg-slate-900" />
              </div>
            </div>
                    ...
                    <tr key={teacher._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20">
                      ...
                      <td className="px-4 py-3">
                        <input type="text" placeholder="Add note..."
                          ...
                          className="w-full px-3 py-1.5 border border-transparent hover:border-border focus:border-[#F59E0B] rounded text-[13px] outline-none bg-transparent focus:bg-white dark:focus:bg-slate-900 transition-colors" />
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="p-4 border-t border-border flex items-center justify-between">
              ...
              <button onClick={handleSave} disabled={submitting}
                className="px-6 py-2.5 bg-[#F59E0B] hover:bg-[#D97706] text-white text-[14px] font-bold rounded-lg shadow-sm transition-colors flex items-center gap-2">
