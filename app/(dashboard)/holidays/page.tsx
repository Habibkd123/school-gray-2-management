      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mt-1">
            <span>Dashboard</span>
            <span>/</span>
            <Link href="/dashboard" className="hover:text-[#1E3A5F]">HRM</Link>
            <span>/</span>
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button onClick={() => fetchHolidays()} className="w-9 h-9 rounded-full bg-white dark:bg-slate-900 border border-border flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-[#1E3A5F] hover:bg-indigo-50 transition-colors shadow-sm cursor-pointer">
            ...
            <tbody className="divide-y divide-border">
              {isLoading ? (
                ...
                <tr key={item._id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 font-semibold text-[#1E3A5F] cursor-pointer hover:text-[#162C47]">
                    {item.display_id}
                  </td>
