    ...
    <div className="space-y-6 bg-[#F8FAFC] dark:bg-[var(--sidebar-bg)] min-h-screen -m-6 p-6 text-left">
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6 text-left">
          ...
          <div className="space-y-1.5">
            <label className="text-[14px] font-bold text-foreground dark:text-slate-100">Holiday Title</label>
            <input 
              type="text" 
              value={formTitle}
          ...
          <div className="space-y-1.5">
            <label className="text-[14px] font-bold text-foreground dark:text-slate-100">Date</label>
            <input 
              type="date" 
              value={formDate}
          ...
          <div className="space-y-1.5">
            <label className="text-[14px] font-bold text-foreground dark:text-slate-100">Description</label>
            <textarea 
