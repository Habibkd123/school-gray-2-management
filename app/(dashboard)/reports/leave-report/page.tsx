                ...
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-72 bg-white dark:bg-slate-900 border border-border rounded-lg shadow-xl z-50 text-left">
                    ...
                    <div className="p-4 flex justify-end gap-3 border-t border-border">
                      <button onClick={() => { setFilterType(""); setFilterStatus(""); }} className="px-5 py-2.5 bg-[#F1F5F9] dark:bg-slate-800 text-foreground text-[13px] font-bold rounded-lg cursor-pointer">Reset</button>
                  ...
                  <tr key={l._id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <div>
                          <div className="font-semibold text-foreground dark:text-slate-100">{user.name}</div>
                          <div className="text-[11px] text-slate-500 dark:text-slate-400">{user.id}</div>
                        </div>
                      </div>
                    </td>
