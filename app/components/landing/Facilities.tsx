    ...
    <section id="facilities" className="py-24 bg-[var(--sidebar-bg)] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-primary font-bold tracking-widest uppercase text-[12px] mb-3">Campus Infrastructure</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-4 gap-6">
          {facilities.map((fac, idx) => (
            <div key={idx} className="bg-white/5 backdrop-blur-md border border-white/10 rounded-sm p-8 flex flex-col items-center justify-center text-center hover:bg-primary transition-colors cursor-pointer group">
