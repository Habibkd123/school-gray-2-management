      ...
      >
        <div className="relative z-10">
          ...
          <p className="text-[13px] text-slate-300 mt-2">
            Manage all registered school institutions, subdomains, and access system configurations.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-left">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-border rounded-xl card-shadow overflow-hidden">
          <div className="p-5 border-b border-border flex items-center justify-between">
            <h3 className="text-[15px] font-bold text-slate-900 dark:text-white">Recent Schools & Subdomains</h3>
            <Link
              href="/schools"
              ...
              <table className="erp-table">
                <thead>
                  <tr className="border-b border-border bg-slate-50/50 dark:bg-slate-900/50">
                    ...
                    <th className="px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-slate-400">Subdomain</th>
