      ...
      {items.length > 0 ? (
        <div className="space-y-4">
          {items.map((item: any, idx: number) => (
            <div key={item._id ?? idx} className="bg-white rounded-sm border border-slate-200 shadow-sm p-6 flex items-start gap-5 hover:shadow-md hover:border-primary/40 transition-all group">
