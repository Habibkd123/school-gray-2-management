      ...
      {sports && (
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="w-14 h-14 bg-[#1E3A5F]/10 rounded-full flex items-center justify-center mb-6"><Trophy className="w-7 h-7 text-[#1E3A5F]" /></div>
              <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Athletics</h2>
        ...
        <section className="py-16 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Arts</h2>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Extracurriculars</h2>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {achievements.map((a: any, i: number) => (
                <div key={a._id ?? i} className="bg-white/5 border border-white/10 rounded-sm p-6 hover:bg-[#1E3A5F]/10 hover:border-[#1E3A5F]/30 transition-all">
                  <Star className="w-6 h-6 text-[#1E3A5F] mb-3" />
                  <span className="text-[#1E3A5F] text-[12px] font-bold uppercase tracking-widest">{a.year}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <Link key={l.href} href={l.href} className="flex items-center justify-between p-5 bg-white border border-slate-200 rounded-sm hover:border-[#1E3A5F] hover:shadow-md transition-all group">
