    ...
    <main className="w-full">
      ...
      <section className="relative py-28 bg-[#0F172A]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <span className="inline-block px-4 py-1.5 bg-[#1E3A5F]/20 border border-[#1E3A5F]/30 text-[#FCA5A5] text-[12px] font-bold uppercase tracking-widest rounded-sm mb-6">Our Curriculum</span>
      ...
      {overview && (
        <section className="py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Overview</h2>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Programs</h2>
      ...
      {faculty.length > 0 && (
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <h2 className="text-[#1E3A5F] font-bold tracking-widest uppercase text-[12px] mb-3">Our Teachers</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <Link key={l.href} href={l.href} className="flex items-center gap-3 p-5 bg-white/5 border border-white/10 rounded-sm hover:bg-[#1E3A5F]/10 hover:border-[#1E3A5F]/30 transition-all group">
                <l.icon className="w-5 h-5 text-[#1E3A5F]" />
                <span className="text-white font-bold text-[14px]">{l.label}</span>
                <ChevronRight className="w-4 h-4 text-white/40 ml-auto group-hover:text-[#1E3A5F]" />
              </Link>
            ))}
          </div>
        </div>
