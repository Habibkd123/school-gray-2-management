...
export default async function AcademicCalendarPage() {
  ...
  return (
    <main className="py-20 px-4 md:px-8 max-w-5xl mx-auto min-h-[60vh]">
      ...
      <p className="text-[#1E3A5F] font-bold uppercase tracking-widest text-[12px] mb-10">Important Dates & Events</p>
      {cal ? (
        <div className="bg-white border border-slate-200 rounded-sm shadow-md p-8">
          <div className="flex items-start gap-4 mb-6">
            <Calendar className="w-8 h-8 text-[#1E3A5F] shrink-0 mt-1" />
