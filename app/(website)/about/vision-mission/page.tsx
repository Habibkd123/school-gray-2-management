...
export default function AboutVisionMissionPage() {
  return (
    <div className="py-20 px-4 md:px-8 max-w-7xl mx-auto min-h-[60vh]">
      <h1 className="text-4xl font-bold mb-6 capitalize">About Vision Mission</h1>
      <p className="text-gray-600 mb-8">This is the placeholder page for the About Vision Mission section.</p>
