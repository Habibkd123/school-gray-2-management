    ...
    <main className="py-20 px-4 md:px-8 max-w-3xl mx-auto min-h-[60vh]">
      ...
      <div className="bg-[var(--sidebar-bg)] p-10 rounded-sm shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" disabled={status === "loading"} className="w-full flex items-center justify-center gap-2 py-4 rounded-sm bg-primary text-white font-bold hover:bg-[var(--primary-hover)] transition-all uppercase tracking-wide disabled:opacity-70">
